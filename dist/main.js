...
/******/ 	return __webpack_require__(__webpack_require__.s = "./entry/client.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _share_head__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../share/head */ "./share/head.js");
...
var fetch = _src_app__WEBPACK_IMPORTED_MODULE_0__["default"].fetch,
    head = _src_app__WEBPACK_IMPORTED_MODULE_0__["default"].head,
    render = _src_app__WEBPACK_IMPORTED_MODULE_0__["default"].render;
var firstPageDataStr = window['__ssrFirstPageData__'] || '{}';
var firstPageData = JSON.parse(firstPageDataStr);
...
var MainApp = function MainApp() {
  ...
  if (!Object.keys(firstPageData).length) {
    Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
      fetch({}).then(function (state) {
        Object(_share_head__WEBPACK_IMPORTED_MODULE_1__["default"])(document, head(state)); // 构建 head
  ...
  console.log('Com---', Com); // 后续可以支持自定义 loading

  if (isLoading) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, "\u6B63\u5728\u52A0\u8F7D\u4E2D");
  } else {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Com, null);
  }
};

if (Object.keys(firstPageData).length) {
  react_dom__WEBPACK_IMPORTED_MODULE_3___default.a.hydrate( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(MainApp, null), document.querySelector('#app'));
} else {
  react_dom__WEBPACK_IMPORTED_MODULE_3___default.a.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(MainApp, null), document.querySelector('#app'));
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _tags__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tags */ "./share/tags.js");
...
var generatorHead = function generatorHead(document, headsObj) {
  return Object.keys(headsObj).forEach(function (tag) {
    console.log('tag', Object(_tags__WEBPACK_IMPORTED_MODULE_0__["default"])(document)[tag]);
    Object(_tags__WEBPACK_IMPORTED_MODULE_0__["default"])(document)[tag](headsObj[tag]);
  });
};

/* harmony default export */ __webpack_exports__["default"] = (generatorHead);
 ...
 */
var generatorTags = function generatorTags(document) {
  var head = document.getElementsByTagName('head')[0];
  return {
    title: function title(tittle) {
    ...
    keywords: function keywords(_keywords) {
      ...
      if (keywordDom) {
        // 修改内容
        keywordDom.setAttribute('content', _keywords);
      } else {
        var keywordTag = document.createElement('meta');
        keywordTag.name = 'keywords';
        keywordTag.setAttribute('content', _keywords);
    ...
    description: function description(_description) {
      ...
      if (desDom) {
        // 修改内容
        desDom.setAttribute('content', _description);
      } else {
        var desTag = document.createElement('meta');
        desTag.name = 'description';
        desTag.setAttribute('content', _description);
    ...
    link: function link(links) {
      ...
      var _loop = function _loop(i) {
        ...
        Object.keys(links[i]).map(function (key) {
    ...
    script: function script(scripts) {
      var fragment = document.createDocumentFragment();
      ...
      var _loop2 = function _loop2(i) {
        ...
        if (scripts[i].type === 'application/ld+json') {
          ...
          Object.keys(scripts[i]).map(function (key) {
            if (key === 'innerHTML') {
...
/* harmony default export */ __webpack_exports__["default"] = (generatorTags);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  render: function render(state) {
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h1", null, state.title), /*#__PURE__*/React.createElement("h2", null, " ", state.description), /*#__PURE__*/React.createElement("h2", null, " ", state.keyword, " "));
  }
});
